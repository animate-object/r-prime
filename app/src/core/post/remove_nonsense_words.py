...
from app.src.repository.words import is_word_query, word_like_query
...
def find_like_word(nonsense_word):
    close_matches = []
    while not close_matches:
        close_matches = word_like_query(nonsense_word)
